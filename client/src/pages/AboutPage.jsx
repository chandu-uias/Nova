...
import StickyButton from '../componets/StickyButton';
// import StickyButton from '../componets/StickyButton';
        ...
        <div>
            ...
            <div className="about-container">
                ...
                <section className="about-image">
                    <img src={"https://res.cloudinary.com/dkf7alzki/image/upload/v1744120995/about_yimvku.jpg"} alt="Photography Studio" />
                </section>
            </div>
            {/* <StickyButton /> */}
        </div>
